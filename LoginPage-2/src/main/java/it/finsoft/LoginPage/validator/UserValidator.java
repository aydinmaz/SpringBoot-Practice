package it.finsoft.LoginPage.validator;
...
public class UserValidator implements Validator 
{
    ...
    public void validate(Object o, Errors errors)
    {
        ...
        //LASTNAME
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "lastname", "NotEmpty");//this line is for checking emptyness
        if (user.getLastname().length() <1  || user.getLastname().length() > 10)//this line is for checking size
        {
